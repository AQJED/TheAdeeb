  ...
  var translations = {
    "en": {
      ...
      "about_subtitle": "12+ Years Experience",
  	  "about_text": "I'm a Software Integration Engineer with a focus on simulation, embedded systems, and artificial intelligence. I hold a B.S. in Computer Engineering from CSUSB and a Deep Learning Nanodegree from MISK Foundation and an A.S. in Electrical & Electronics (Instrumentation and Control Systems) from Yanbu Industrial College. My passion lies in building intelligent systems that bridge the physical and digital worlds.\nI’ve worked across multiple roles, gaining expertise in middleware development, real-time data integration, and system optimization.\nMy technical expertise includes microcontroller programming, circuit design, hardware-software integration, and software development in defense and aerospace applications, developing low-latency solutions and integrating next-generation technologies into complex systems.",
